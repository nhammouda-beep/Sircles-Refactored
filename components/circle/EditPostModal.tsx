...
/**
 * Page-sheet style modal for editing post content.
 */
      ...
      <SafeAreaView style={[styles.container, { backgroundColor }]}>
        <View style={[styles.header, { backgroundColor: surfaceColor }]}>
          <TouchableOpacity onPress={onCancel}>
            <ThemedText style={[styles.cancelButton, { color: CIRCLE_COLORS.primary }]}>
              Cancel
            </ThemedText>
          </TouchableOpacity>
          <ThemedText style={styles.title}>Edit Post</ThemedText>
          <TouchableOpacity onPress={onSave} disabled={!canSave}>
            <ThemedText
              style={[
                styles.saveButton,
                { color: canSave ? CIRCLE_COLORS.primary : textColor + "50" },
              ]}
            >
              Save
            </ThemedText>
